  ...
  return (
    <>
      ...
      >
        ...
        >
          <TopNoticeBanner
            className='pointer-events-auto border-border/50 bg-background/92 backdrop-blur-2xl'
            containerClassName={cn(
              scrolled ? 'max-w-[52rem] px-4' : 'max-w-7xl px-4 md:px-6'
            )}
          />
        </div>
