...
export function SystemInfoSection({ defaultValues }: SystemInfoSectionProps) {
  ...
  const normalizedDefaults: SystemInfoFormValues = {
    ...
    SystemSubtitle: normalizeValue(defaultValues.SystemSubtitle),
        ...
        <Form {...form}>
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('System Subtitle')}</FormLabel>
                  <FormControl>
                    <Input
                      placeholder={t('A concise subtitle for your site')}
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
                    {t('Used together with the system name for page titles and branding')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder={t('Enter SEO description for search engines')}
                      rows={3}
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
                    {t('Applied to the home page meta description')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {t('Comma-separated keywords written into the page meta tag')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
