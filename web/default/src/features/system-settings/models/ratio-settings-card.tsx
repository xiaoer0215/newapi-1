...
const groupSchema = z.object({
  ...
  UserGroupIcons: z.string().superRefine((value, ctx) => {
    const result = validateJsonString(value)
    if (!result.valid) {
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
...
export function RatioSettingsCard({
  ...
  const groupNormalizedDefaults = useRef({
    ...
    UserGroupIcons: normalizeJsonString(groupDefaults.UserGroupIcons),
  ...
  const groupForm = useForm<GroupFormValues>({
    ...
    defaultValues: {
      ...
      UserGroupIcons: formatJsonForTextarea(groupDefaults.UserGroupIcons),
  ...
  const saveGroupRatios = useCallback(
    async (values: GroupFormValues) => {
      const normalized = {
        ...
        UserGroupIcons: normalizeJsonString(values.UserGroupIcons),
