        ...
        {editMode === 'visual' ? (
          <div className='space-y-6'>
            <GroupRatioVisualEditor
              ...
              userGroupIcons={form.watch('UserGroupIcons')}
          ...
          <form onSubmit={form.handleSubmit(onSave)} className='space-y-6'>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Group icons')}</FormLabel>
                  <FormControl>
                    <Textarea rows={8} {...field} />
                  </FormControl>
                  <FormDescription>
                    {t(
                      'JSON map of group to icon source. Values can be inline SVG markup, image URLs, or data:image content.'
                    )}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {t(
                      'Nested JSON: source group → { targetGroup: ratio } to override billing when a user in one group uses a token of another group.'
                    )}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
