...
export type ContentSettings = {
  ...
  'console_setting.top_notice_items': string
  'console_setting.top_notice_rotation_seconds': number
  ...
  'console_setting.contact_caption': string
  'console_setting.contact2_enabled': boolean
  'console_setting.contact_image2': string
  'console_setting.contact_title2': string
  'console_setting.contact_caption2': string
  'console_setting.api_info_enabled': boolean
  'console_setting.announcements_enabled': boolean
  'console_setting.top_notice_enabled': boolean
  ...
  MemberUpgradeEnabled: boolean
  MemberUpgradeAdminOnly: boolean
  MemberUpgradeFAQ: string
  MemberBalanceConversionTitle: string
  MemberBalanceConversionContent: string
