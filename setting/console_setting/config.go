...
type ConsoleSetting struct {
	...
	PricingContextEnabled         bool   `json:"pricing_context_enabled"`
	PricingMaxOutputEnabled       bool   `json:"pricing_max_output_enabled"`
	PricingModalitiesEnabled      bool   `json:"pricing_modalities_enabled"`
	PricingKnowledgeCutoffEnabled bool   `json:"pricing_knowledge_cutoff_enabled"`
	PricingReleaseDateEnabled     bool   `json:"pricing_release_date_enabled"`
	PricingCapabilitiesEnabled    bool   `json:"pricing_capabilities_enabled"`
...
var defaultConsoleSetting = ConsoleSetting{
	...
	ContactCaption2:               "",
	ApiInfoEnabled:                true,
	PricingContextEnabled:         true,
	PricingMaxOutputEnabled:       true,
	PricingModalitiesEnabled:      true,
	PricingKnowledgeCutoffEnabled: true,
	PricingReleaseDateEnabled:     true,
	PricingCapabilitiesEnabled:    true,
